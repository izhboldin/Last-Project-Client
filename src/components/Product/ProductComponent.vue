<template>
    <div class="container">
        <div v-if="product" class="row g-3">
            ...
            <div class="col-8">
                ...
                <div class="p-3 bg-body">
                    ...
                    <div>
                        ...
                        <p class="card-text my-1 d-flex" ><div class="d-flex align-items-center bg-light p-2 me-2" v-for="option in product.options">
            ...
            <div class="col-4">
                <div class="p-3 bg-body mb-3">
                    <p class="text-center"><small class="text-muted">Дата публикации: {{ format(new Date(product.created_at), "yyyy-MM-dd")}}</small></p>
                    <h5>{{product.title}}</h5>
                ...
                <div class="p-3 bg-body">
                    ...
                    <div class="d-flex m-2">
                        <img src="https://lh3.googleusercontent.com/ogw/ANLem4afL67FThoAbnFlPCV9H4ZDAwh-v8UILFH30VLztg=s32-c-mo" style="height: 36px; width: 36px;" alt="" class="img-fluid object-fit-cover rounded-circle me-2">
                        <h6 class="my-1">{{product.user.name}}</h6>
                    </div>
                    <p class=""><small class="text-muted">На сайте с {{format(new Date(product.user.created_at), "yyyy-MM-dd")}}</small></p>
                    <!-- <button class="btn btn-outline-info w-100 mb-2" type="button">Написать</button> -->
